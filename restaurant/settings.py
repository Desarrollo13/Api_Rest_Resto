...
SECRET_KEY = "django-insecure-=5vzz%9z&k4mgr$ree!%un=k&!0t@y&j978$p$q=&1f#wzd^c$"
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',  # para invalidar tokens al logout
...
REST_FRAMEWORK = {
    ...
    # Por defecto cualquier endpoint requiere estar autenticado
...
AUTH_USER_MODEL = 'users.Usuario'  # app_label.NombreModelo
